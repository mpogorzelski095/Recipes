    ...
    {{--<form method="post" enctype="multipart/form-data" action="{{ route('sortFavorite') }}">--}}
        ...
        {{--<div class="input-group mb-3">--}}
            ...
            {{--<select name="sortFavorite" class="custom-select" id="inputGroupSelect01">--}}
                {{--<option href="/?sortFavorite=1" value="1" {{ $option == '1'  ? "selected" : "" }} >Latest</option>--}}
                {{--<option href="/?sortFavorite=2" value="2" {{ $option == '2'  ? "selected" : "" }} >Oldest</option>--}}
                {{--<option href="/?sortFavorite=3" value="3" {{ $option == '3'  ? "selected" : "" }} >Like</option>--}}
                {{--<option href="/?sortFavorite=4" value="4" {{ $option == '4'  ? "selected" : "" }} >Comments</option>--}}
            {{--</select>--}}
        {{--</div>--}}
