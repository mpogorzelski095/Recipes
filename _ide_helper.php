 ...
 * Generated for Laravel 5.6.39 on 2018-12-04 19:26:46.
 *
...
namespace Yish\Imgur\Facades { 
    ...
    class Upload {
        ...
        {
            return \Yish\Imgur\Upload::setSize($size);
        }
        ...
        {
            return \Yish\Imgur\Upload::setHeaders($headers);
        }
        ...
        {
            return \Yish\Imgur\Upload::setFormParams($params);
        }
        ...
        {
            return \Yish\Imgur\Upload::upload($image);
        }
        ...
        {
            return \Yish\Imgur\Upload::filesize();
        }
        ...
        {
            return \Yish\Imgur\Upload::width();
        }
        ...
        {
            return \Yish\Imgur\Upload::height();
        }
        ...
        {
            return \Yish\Imgur\Upload::usual();
        }
        ...
        {
            return \Yish\Imgur\Upload::size($url, $size);
        }
